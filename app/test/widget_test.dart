...
import 'package:mapa_assistivo/main.dart';

void main() {
  testWidgets('exibe mapa e planejamento de rota', (WidgetTester tester) async {
    await tester.pumpWidget(const AssistiveMapApp());
